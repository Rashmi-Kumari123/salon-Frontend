      ...
      <section className=" hidden md:col-span-1 md:flex  lg:col-span-2  justify-center items-center">
        <div className="lg:w-[70%] px-5 space-y-10">
          <div className="borderr rounded-md space-y-2 font-bold text-center">
            <p className="text-3xl tracking-wide text-gray-800">Join the Marketplace Revolution</p>
            <p className="text-xl text-teal-600 font-semibold"> Boost Your Sales Today</p>
          </div>

          <img className="rounded-lg shadow-lg" src="" alt="" />
          <div>
          ...
          <div className="text-center">
            <button className="bg-teal-500 hover:bg-teal-600 text-white font-semibold px-6 py-2 rounded-md shadow-md transition">
              Learn More
            </button>
          </div>
        </div>
